...
public class AccompanimentGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "Accompaniment"; } }
    public override string Description    { get { return "Accompaniment"; } }
    public override string Vendor         { get { return "Will Ozeas"; } }

    //==============================================================================
    [DllImport("Accompaniment")] static extern System.IntPtr getRenderCallback();

    [DllImport("Accompaniment")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("Accompaniment")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("Accompaniment")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("Accompaniment")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("Accompaniment")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("Accompaniment")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
