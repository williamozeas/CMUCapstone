...
public class MusicBoxGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "MusicBox"; } }
    public override string Description    { get { return "MusicBox"; } }
    public override string Vendor         { get { return "Will Ozeas"; } }

    //==============================================================================
    [DllImport("MusicBox")] static extern System.IntPtr getRenderCallback();

    [DllImport("MusicBox")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("MusicBox")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("MusicBox")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("MusicBox")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("MusicBox")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("MusicBox")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
